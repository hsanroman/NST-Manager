 ...
 * Please see the [Nest Manager Community Forum Link](https://community.smartthings.com/t/release-nest-manager-4-0/) for New Features
 * Instructions are here [Nest Manager Things that are Smart Wiki](http://thingsthataresmart.wiki/index.php?title=Nest_Manager)
